          ...
          {step === "upload" && (
            <div className="flex flex-col gap-4">
              <p className="text-sm text-neutral-600">
                Export your WhatsApp chat, upload it here — links are found
                automatically.
              </p>
              <div className="rounded-lg border border-dashed border-neutral-300 bg-neutral-50 p-4 text-xs text-neutral-500">
                <p className="font-medium text-neutral-700">How to export?</p>
                <p className="mt-1">
                  WhatsApp → Open chat → Top right &quot;···&quot; → <strong>Export Chat</strong> →{" "}
            ...
            <div className="flex flex-col gap-3">
              <div className="flex items-center justify-between">
                <span className="text-sm text-neutral-600">
                  <strong>{urls.length}</strong> links found
                </span>
                <button
                  onClick={toggleAll}
              ...
              {urls.length === 0 ? (
                <p className="rounded-lg bg-amber-50 px-4 py-3 text-sm text-amber-700">
                  No links found in this file. Make sure you exported the right chat.
                </p>
              ) : (
            ...
            <div className="flex flex-col gap-4">
              <div className="grid grid-cols-3 gap-3 text-center">
                ...
                <div className="rounded-xl bg-neutral-100 px-3 py-3">
                  ...
                  <p className="text-xs text-neutral-500">Already saved</p>
                </div>
              ...
              {result.created > 0 && (
                <p className="text-sm text-neutral-500">
                  New links will be analyzed by AI — this may take a few minutes.
                </p>
              )}
              <button
                onClick={handleClose}
